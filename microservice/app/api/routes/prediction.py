...
from app.schemas import GetPredictionRequest, SimplePredictionResponse

router = APIRouter(prefix="/prediction", tags=["prediction"])


@router.get("/dummy", response_model=SimplePredictionResponse)
...
@router.get("/linear_regression", response_model=SimplePredictionResponse)
...
@router.get("/random_forest", response_model=SimplePredictionResponse)
